    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-center justify-between md:py-2 px-4 border-b rounded-t dark:border-gray-600">
                ...
                <button data-modal-hide="modalFirstService" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modalFirstService">
            ...
            <div class="p-4 md:py-5 px-4 space-y-4">
                ...
                <h2 class="text-center">Legalização e Abertura de Empresas</h2>

                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    A Legalização de Empresas é o caminho crucial para regularizar seu negócio. Cada processo é único, variando conforme sua localização e a natureza da atividade. Garanta a regularização do seu empreendimento hoje mesmo, entre em contato para iniciar o processo.
                </p>
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
