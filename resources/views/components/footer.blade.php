                    ...
                    <div class="col-span-2">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="col-span-1">
                                ...
                                <ul class="list-none p-0">
                                    <li><a href="#" class="w-fit inline-block py-1 text-sm text-gray-400 hover:text-sky-600 transition-all duration-200">Sobre nós</a></li>
                                    <li><a href="#" class="w-fit inline-block py-1 text-sm text-gray-400 hover:text-sky-600 transition-all duration-200">Serviços</a></li>
                                    <li><a href="#" class="w-fit inline-block py-1 text-sm text-gray-400 hover:text-sky-600 transition-all duration-200">Contato</a></li>
                                    <li><a href="#" class="w-fit inline-block py-1 text-sm text-gray-400 hover:text-sky-600 transition-all duration-200">Políticas de Privacidade</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
