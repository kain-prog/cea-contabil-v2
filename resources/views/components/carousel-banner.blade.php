<div id="default-carousel" class="relative" data-carousel="slide">
    ...
    <div id="carousel-height" class="overflow-hidden relative">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <img src="/assets/images/escritorio-banner1.jpg" class="brightness-75 object-cover h-full block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            <div class="flex flex-col items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 m-auto max-w-3xl">
                ...
                <p class="py-3 px-6 bg-white text-black rounded-md text-xs font-bold hover:bg-transparent border border-white transition-all duration-200 hover:text-white cursor-pointer">CONECTE-SE CONOSCO</p>
            </div>
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/assets/images/escritorio-banner2.jpg" class="brightness-75 object-cover h-full block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            <div class="flex flex-col items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 m-auto max-w-3xl">
        ...
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/assets/images/escritorio-banner3.jpg" class="brightness-75 object-cover h-full block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            <div class="flex flex-col items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 m-auto max-w-3xl">
