<section id="about" class="bg-gray-100 py-8">
    ...
    <div class="flex flex-col m-auto px-4 xl:max-w-6xl lg:max-w-4xl md:max-w-2xl columns-1 sm:max-w-lg gap-12 lg:flex-row items-center">
        ...
        <div class="desc relative pb-12 xl:max-w-md lg:max-w-md lg:pt-11">
            ...
            negócio com confiança e tranquilidade.</p>

            <p class="text-gray-500">Nosso propósito é simples: colocamos em prática todo nosso 
            conhecimento adquirido em prol do sucesso e crescimento dos nossos 
            clientes e parceiros. Temos uma missão diferenciada dentro do mercado, 
            através de 3 pilares fundamentais: redução da burocracia, melhoria do fluxo 
            de trabalho e relacionamento com nossos clientes.</p>
        </div>
    </div>
